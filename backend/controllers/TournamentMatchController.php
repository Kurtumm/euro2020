...
use Yii;
use common\models\ft\TournamentMatch;
use common\models\ft\search\TournamentMatch as TournamentMatchSearch;
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            try {
                ...
                if($flag) {
                    $transaction->commit();
                    return $this->redirect(['view', 'id' => $model->tournamentMatchId]);
                } else {
